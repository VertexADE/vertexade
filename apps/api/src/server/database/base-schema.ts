export const baseSchema = `
  ...
  CREATE TABLE IF NOT EXISTS jobs (
    ...
    latest_activity TEXT, activity_at TEXT, turn_started_at TEXT, latest_diff TEXT,
    ...
    archived_at TEXT, settled_at TEXT, snoozed_until TEXT, pr_merged_at TEXT, agent_id TEXT NOT NULL DEFAULT 'codex',
