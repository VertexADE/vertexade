...
export const FileTreeFolder = ({ path, name, count, className, children, ...props }: FileTreeFolderProps) => {
        ...
        <div className={cn('', className)} role="treeitem" tabIndex={0} {...props}>
          ...
          >
            ...
            >
              ...
              {count !== undefined && <span className="ml-auto text-[10px] text-muted-foreground">{count}</span>}
            </button>
          </div>
          <CollapsibleContent>
