...
const SIDEBAR_WIDTH_MOBILE = 'min(21rem, calc(100vw - 1.5rem))'
...
function SidebarProvider({
  ...
  const toggleSidebar = React.useCallback(() => {
    ...
    if (desktopToggleEnabled) return setOpen((open) => !open)
  }, [desktopToggleEnabled, isMobile, setOpen, setOpenMobile])

  // Adds a keyboard shortcut to toggle the sidebar.
  React.useEffect(() => {
    if (!isMobile && !desktopToggleEnabled) return
  ...
  }, [desktopToggleEnabled, isMobile, toggleSidebar])
      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            ...
            <SheetDescription>Navigate VertexADE and check server availability.</SheetDescription>
          </SheetHeader>
